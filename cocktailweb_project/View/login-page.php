...
?>
    ...
    <head>
        <link rel="icon"
              href="https://cdn.discordapp.com/attachments/927911630602403880/931129861945294849/cocococococococockail.png">
        <meta charset="UTF-8">
                ...
                <div class="sign-in-htm">
                    <form method="post">
                        ...
                        <div class="group">
                            ...
                            <input id="pass-signin" name="password-signin" type="password" class="input"
                ...
                <div class="sign-up-htm">
                    <form method="post">
                        ...
                        <div class="group">
                            ...
                            <input id="pass-signup" name="password-signup" type="password" class="input"
                                   data-type="password" required>
                        </div>
                        <div class="group">
                            <label for="pass-confirm-signup" class="label">Répéter le mot de passe</label>
                            <input id="pass-confirm-signup" name="confirm_password-signup" type="password" class="input"
                                   data-type="password" required>
                        </div>
                        <div class="group">
