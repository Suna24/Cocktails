...
<div class="page">
    <form id="ajouter" method="post" action="../Model/ajout.php">
        ...
        <fieldset>
            <h3>Le cocktail</h3>
            <input class="cocktailName" id="cocktailName" type="text" placeholder="Le nom de votre cocktail"
        ...
        <fieldset id="ing">
            ...
            <div id="firstNode" class="ingredient">
                <input id="ingredient" class="nameIngredient" list="ingredients" type="text" placeholder="Ingrédient"
                       required/>
